...
export default function Courses() {
  ...
  const handleEnrollClick = () => {
    if (!user) {
      ...
      toast.success("Redirecting to WhatsApp for enrollment...");
      window.open(
        "https://wa.me/919226221871",
        "_blank",
        "noopener,noreferrer"
      );
    }
  ...
  const handleLoginSuccess = () => {
    // After successful login, redirect to WhatsApp
    toast.success(
      "Login successful! Redirecting to WhatsApp for enrollment..."
    );
    setIsAuthModalOpen(false);
    window.open("https://wa.me/919226221871", "_blank", "noopener,noreferrer");
  };
